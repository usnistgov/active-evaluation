...
htmlhelp_basename = "AegisActiveEvaluator"
...
latex_documents = [
    (master_doc, "Aegis.tex", "AEGIS Documentation", "NIST BTF Team", "manual")
]
...
man_pages = [(master_doc, "aegis", "Aegis Documentation", [author], 1)]
